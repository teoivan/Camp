 ...
 */
final class Version20240705133521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workout CHANGE type_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workout CHANGE user_id type_id INT NOT NULL');
